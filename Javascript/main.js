document.addEventListener("DOMContentLoaded", function () {
    ...
    function buildNav() {
        ...
        // BETTER PATH DETECTION - Check the actual folder structure
        function getPathPrefix() {
            const path = window.location.pathname;
            console.log('[nav] current path:', path);

            // If we're in Articles or Portfolio folders, go up one level
            if (path.includes('/Articles/') || path.includes('/Portfolio/')) {
                return '../';
            }
        ...
        console.log('[nav] using pathPrefix:', pathPrefix);
